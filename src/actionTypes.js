...
export const SET_TOTEM = 'SET_TOTEM'
export const SET_SOULSTONES = 'SET_SOULSTONES'
export const UPDATE_SOULSTONES = 'UPDATE_SOULSTONES'
export const ADD_MEMBER = 'ADD_MEMBER'
export const DELETE_MEMBER = 'DELETE_MEMBER'
export const SELECT_MEMBER = 'SELECT_MEMBER'
export const SELECT_MERC = 'SELECT_MERC'
export const CLEAR_MEMBERS = 'CLEAR_MEMBERS'
export const DELETE_TOTEM = 'DELETE_TOTEM'
export const RESET_SOULSTONES = 'RESET_SOULSTONES'
