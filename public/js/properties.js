...
window.Properties = (function() {
  ...
  Properties.prototype.bindEvents = function() {
    ...
    this.meta.on('click', '.prop-order', (function(_this) {
      return function(e) {
        var input;
  ...
  Properties.prototype.clearAppearanceOptions = function() {
    this.el.find('.prop-appearance').html('');
    $('.style-tab-button').addClass('hidden');
    return $('#properties-tabs').assemblyTabs('show', 1);
  };
  ...
  Properties.prototype.clearConfigOptions = function() {
    this.el.find('.prop-config').html('');
    $('.data-tab-button').addClass('hidden');
    return $('#properties-tabs').assemblyTabs('show', 0);
  };
